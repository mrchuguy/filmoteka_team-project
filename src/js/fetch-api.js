...
export default class ApiService{
    ...
    findTrending() {
        return axios.get(`${settings.BASE_URL}/trending/movie/day?api_key=${settings.API_KEY}`, {
            params: {
             page: `${this.page}`,
            }
}
    ...
    findById(id) {
        return axios.get(`${settings.BASE_URL}/movie/${id}?api_key=${settings.API_KEY}`, {
}
    ).catch(function (error) {
    if (error.response) {
      console.log(error.response.data);
    ...
    console.log(error.config);
     ...
     findByKeyword() {
        return axios.get(`${settings.BASE_URL}/search/movie?api_key=${settings.API_KEY}&language=en-US&query=${this.searchQuery}&include_adult=false`, {
            params: {
                page: `${this.page}`,  
            }
}
    ...
    console.log(error.config);
      ...
      getMovieGenres() {
        return axios.get(`${settings.BASE_URL}/genre/movie/list?api_key=${settings.API_KEY}`, {
            }
    ).catch(function (error) {
    if (error.response) {
      console.log(error.response.data);
